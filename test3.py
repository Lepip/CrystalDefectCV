...
#         shape = img.shape
#         for x in range(0, shape[0] - size_img-7, 7):
#             for y in range(0, shape[1] - size_img-7, 7):
...
#                     if cv2.imwrite("./pictures/red/" + str(num_red) + ".png", img_orig_crop) == False:
#                         print("aboba")
#                     num_red += 1
#                 elif random.randint(1, 10) == 5:
#                     img_orig_crop = img_orig[x:x + size_img, y:y + size_img]
#                     cv2.imwrite("./pictures/nor/" + str(num_plain) + ".png", img_orig_crop)
#                     num_plain += 1
